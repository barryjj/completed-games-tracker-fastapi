...
# Title heuristics live in the platform-neutral titles module (lifted for the
# PSN sync — one implementation, one test suite). Re-exported here so existing
# imports (`from backend.steam import _infer_is_collection`) keep working.
from .titles import (  # noqa: F401
    _COLLECTION_RE,
    _clean_title,
    _infer_is_collection,
    _is_loud_caps,
    _smart_title_case,
)
